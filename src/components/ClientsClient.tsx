    ...
    fetch('/api/clients')
      ...
      .then(data => {
        if (data.clients && data.clients.length > 0) {
          const mapped: Client[] = data.clients.map((c: any) => ({
            id: String(c.id), name: c.name, logoUrl: c.logoUrl || '',
            website: c.website || '', isActive: c.isActive === 1 || c.isActive === true, sortOrder: c.sortOrder || 0,
          }));
