                  ...
                  <tbody>
                    {!mounted ? (
                      ...
                      <tr key={inquiry.id} className="border-b border-white/5">
                        ...
                        <td className="p-4">
                          <p className="text-slate-300 text-sm">{inquiry.EmailIcon}</p>
                          <p className="text-slate-400 text-sm">{inquiry.PhoneIcon}</p>
                        </td>
          ...
          <div className="glass-card rounded-2xl p-6 w-full max-w-2xl">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-slate-400">EmailIcon</p>
                  <p className="text-white">{selectedInquiry.EmailIcon}</p>
                </div>
                <div>
                  <p className="text-sm text-slate-400">PhoneIcon</p>
                  <p className="text-white">{selectedInquiry.PhoneIcon}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                <a
                  href={`mailto:${selectedInquiry.EmailIcon}`}
                ...
                <a
                  href={`https://wa.me/${selectedInquiry.PhoneIcon.replace(/[^0-9]/g, "")}`}
                  target="_blank"
