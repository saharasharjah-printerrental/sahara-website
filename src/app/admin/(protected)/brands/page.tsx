...
export default function AdminBrands() {
  ...
  return (
    <div className="min-h-screen bg-[#071325]">
      ...
      {showModal && (
        <BrandModal brand={editingBrand} onSave={handleSave} onCloseIcon={() => { setShowModal(false); setEditingBrand(null); }} />
      )}
    </div>
  );
}

function BrandModal({ brand, onSave, onCloseIcon }: { brand: Brand | null; onSave: (b: Brand) => void; onCloseIcon: () => void }) {
