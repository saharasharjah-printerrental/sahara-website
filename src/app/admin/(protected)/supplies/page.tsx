    ...
    <div className="min-h-screen bg-[#071325]">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 rounded-lg bg-[#101c2e] flex items-center justify-center">
                            {supply.color ? (
                              ...
                              <span className="material-symbols-outlined text-slate-400">SettingsIcon</span>
                            )}
                          </div>
                          <div>
      ...
      {showModal && (
        <SupplyModal
          ...
          onSave={handleSave}
          onCloseIcon={() => { setShowModal(false); setEditingSupply(null); }}
          brands={brands}
...
function SupplyModal({ supply, onSave, onCloseIcon, brands, categories }: { supply: Supply | null; onSave: (s: Supply) => void; onCloseIcon: () => void; brands: string[]; categories: string[] }) {
