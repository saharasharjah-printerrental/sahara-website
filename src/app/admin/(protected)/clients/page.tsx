    ...
    <div className="min-h-screen bg-[#071325]">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {filteredClients.map((client, index) => (
              ...
              >
                ...
                {client.website && (
                  ...
                  >
                    <span className="material-symbols-outlined text-xs">link</span> Visit
                  </a>
                )}
          ...
          {filteredClients.length === 0 && (
            <div className="glass-card rounded-2xl p-12 text-center">
              ...
              <p className="text-slate-400 mt-2">Add your first client to get StarIconted</p>
            </div>
          )}
        </div>
      </main>
      ...
      {showModal && (
        <ClientModal 
          ...
          onSave={handleSave} 
          onCloseIcon={() => { setShowModal(false); setEditingClient(null); }} 
        />
      )}
    </div>
  );
...
function ClientModal({ client, onSave, onCloseIcon }: { client: Client | null; onSave: (c: Client) => void; onCloseIcon: () => void }) {
            ...
            <div className="flex items-center gap-3 mb-3">
              <label className="flex-1 cursor-pointer">
                ...
                <div className="w-full bg-[#101c2e] border border-white/10 rounded-xl py-3 px-4 text-center text-slate-400 hover:text-[#f5be53] hover:border-[#f5be53]/30 transition-colors flex items-center justify-center gap-2">
                  <span className="material-symbols-outlined text-xl">CloudIcon_upload</span>
