...
export default function AdminBanners() {
  ...
  return (
    <div className="min-h-screen bg-[#071325]">
      ...
      {showModal && (
        <BannerModal banner={editingBanner} onSave={handleSave} onCloseIcon={() => { setShowModal(false); setEditingBanner(null); }} />
      )}
    </div>
  );
}

function BannerModal({ banner, onSave, onCloseIcon }: { banner: Banner | null; onSave: (b: Banner) => void; onCloseIcon: () => void }) {
