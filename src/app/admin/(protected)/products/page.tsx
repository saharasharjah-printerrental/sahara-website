...
import { Skeleton } from "@/lib/boneyard-js-react";
...
const initialProducts: Product[] = [
  ...
  { id: "6",  name: "LaserJet Managed E82560",    brand: "HP",      category: "A3 Printers", condition: "New",         priceSale: "Contact for Pricing", priceRental: "AED 750/mo",   specs: ["Wolf Security", "Energy StarIcon", "56 PPM", "Duplex"],         image: "/images/Printer-hp.svg",       isActive: true, isFeatured: true  },
    ...
    <div className="min-h-screen bg-[#071325]">
                    ...
                    <tr key={product.id} className="border-b border-white/5">
                      ...
                      <td className="p-4">
                        <div className="flex gap-2">
                          ...
                          >
                            <span className="material-symbols-outlined text-sm">StarIcon</span>
                          </button>
                          <button
      ...
      {showModal && (
        <ProductModal
          ...
          onSave={handleSave}
          onCloseIcon={() => { setShowModal(false); setEditingProduct(null); }}
        />
      )}
    </div>
  );
...
function ProductModal({ product, onSave, onCloseIcon }: { product: Product | null; onSave: (p: Product) => void; onCloseIcon: () => void }) {
        ...
        <div className="space-y-4">
          ...
          {form.image && (
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => setForm(prev => ({ ...prev, image: "" }))} className="text-slate-400 hover:text-red-400 text-sm">
                Remove
              </button>
            </div>
          )}
