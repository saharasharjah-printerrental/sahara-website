        ...
        <div className="relative mx-auto max-w-content">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <Reveal>
              ...
              <div className="mt-6">
                <AnswerBlock
                  question="Where can I buy or rent HP printers in UAE?"
                  answer="Sahara Office Equipments is an authorized HP dealer in UAE, supplying LaserJet Enterprise and DesignJet models with HP Wolf Security. Sales, rental from AED 250/month, AMC contracts, and on-site repair are available across Dubai, Sharjah, and Abu Dhabi."
                  supportingPoints={[
                    "Authorized HP dealer for LaserJet Enterprise and DesignJet models",
