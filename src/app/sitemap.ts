...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/printer-repair-sharjah/`,       lastModified: thisWeek, changeFrequency: 'weekly',  priority: 0.85 },
    { url: `${BASE}/kyocera-printer-repair/`,       lastModified: thisWeek, changeFrequency: 'weekly',  priority: 0.8 },
    { url: `${BASE}/hp-printer-repair/`,            lastModified: thisWeek, changeFrequency: 'weekly',  priority: 0.8 },
    { url: `${BASE}/canon-printer-repair/`,         lastModified: thisWeek, changeFrequency: 'weekly',  priority: 0.8 },
    { url: `${BASE}/brother-printer-repair/`,       lastModified: thisWeek, changeFrequency: 'weekly',  priority: 0.75 },
    { url: `${BASE}/epson-printer-repair/`,         lastModified: thisWeek, changeFrequency: 'monthly', priority: 0.65 },
    { url: `${BASE}/xerox-printer-repair/`,         lastModified: thisWeek, changeFrequency: 'monthly', priority: 0.65 },
    { url: `${BASE}/ricoh-printer-repair/`,         lastModified: thisWeek, changeFrequency: 'monthly', priority: 0.65 },
