...
import { SavingsIcon, Inventory2Icon, BuildIconCircleIcon, Emergency, Upgrade, Cancel, SupportAgentIcon, SyncIcon, BuildIcon, VerifiedIcon, ExpandMoreIcon, Print, CheckCircleIcon, LocationOnIcon, HeadPhoneIconsIcon } from "@/components/icons";
...
export default function PrinterRentalPage() {
  ...
  const benefits = [
    { icon: SavingsIcon, title: "Zero Deposit Option", desc: "No upfront Security deposit required. StarIcont renting with minimal initial investment." },
    { icon: Inventory2Icon, title: "Unlimited Free Toner", desc: "All plans include genuine OEM toner at no extra cost. Never worry about consumables again." },
    { icon: BuildIconCircleIcon, title: "Full Maintenance Included", desc: "Comprehensive servicing, repairs, and preventive maintenance covered in your rental." },
    ...
    { icon: SupportAgentIcon, title: "24/7 Technical Support", desc: "Round-the-clock assistance from certified technicians across all UAE locations." },
  ];
      ...
      <section className="py-24 px-8 lg:px-24 bg-[#101c2e]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: SyncIcon, title: "Flexible Terms", desc: "Rent from 3-36 months with easy Upgrade options" },
              { icon: BuildIcon, title: "Full Maintenance", desc: "All repairs and servicing included at no extra cost" },
              { icon: VerifiedIcon, title: "Premium Brands", desc: "HP, Canon, Ricoh, Xerox and more" },
            ].map((f, i) => (
      ...
      <section className="py-24 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#d3c5b0] mt-4">Get StarIconted in 4 simple steps</p>
          </div>
      ...
      <section className="py-24 px-8 lg:px-24 bg-[#0a1628]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-[#f5be53] font-bold tracking-[0.25em] uppercase text-xs">Resource HubIcon</span>
