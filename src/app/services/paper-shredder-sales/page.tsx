...
const DEFAULT_FAQS: FaqItem[] = [
  ...
  { q: "Does Sahara sell paper shredders across Dubai and the wider UAE?", a: "Yes. Sahara sells and delivers paper shredders across Dubai, Sharjah, Abu Dhabi, Ajman, and Ras Al Khaimah, including free zones like JAFZA, SAIF Zone, and DIFC. Purchase prices start from AED 800; rental is also available from AED 150/month." },
];
