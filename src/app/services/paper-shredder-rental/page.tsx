...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Can I rent a paper shredder for a single day or event in UAE?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Sahara Office Equipments offers short-term paper shredder rental in Dubai, Sharjah, and Abu Dhabi with flexible, customised contract lengths — ideal for office clear-outs, events, and compliance audits. Tell us your dates and we'll confirm availability." } },
    { "@type": "Question", "name": "What types of shredders are available for rent in UAE?", "acceptedAnswer": { "@type": "Answer", "text": "We supply Fellowes Powershred cross-cut shredders (DIN P-4 security level) in both personal/light-office and departmental capacities, plus heavy-duty industrial models for bulk destruction on request. All are compliant with UAE data protection and GDPR standards." } },
    { "@type": "Question", "name": "Is paper shredder rental better than buying in UAE?", "acceptedAnswer": { "@type": "Answer", "text": "For occasional or seasonal use, rental is significantly cheaper than buying. A good office shredder costs AED 800–3,000 to buy. Renting from AED 150 gives you the same quality with maintenance included and no capital expenditure. For daily, high-volume shredding, buying can be the better long-term option." } },
    ...
    { "@type": "Question", "name": "Can I buy a paper shredder instead of renting one?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Sahara sells paper shredders outright as well as renting them. For offices that shred only occasionally, renting from AED 150 (with maintenance and repairs included) usually works out cheaper than buying outright at AED 800–3,000+. For daily, high-volume shredding, buying can make sense — ask us for a side-by-side quote and we'll recommend whichever is cheaper for your actual usage." } },
    { "@type": "Question", "name": "What's the difference between the paper shredders Sahara offers in the UAE?", "acceptedAnswer": { "@type": "Answer", "text": "Sahara's UAE shredder range covers the Fellowes Powershred LX65 (10 sheets/pass, personal or light-office use) and the Fellowes Powershred 325Ci (24 sheets/pass, departmental/commercial use), both DIN P-4 cross-cut, plus heavy-duty models for high-volume clear-outs on request. All are available to rent or buy, with free delivery across Dubai, Sharjah, and Abu Dhabi." } },
            ...
            <div className="max-w-3xl">
              ...
              <div className="bg-[#0d1b2e] border border-[#f5be53]/20 rounded-2xl p-5 mb-8">
                ...
                <p className="text-[#d3c5b0] text-sm leading-relaxed">
                  Paper shredder rental in UAE lets offices securely destroy confidential documents without the capital cost of buying. Sahara supplies Fellowes Powershred DIN P-4 cross-cut shredders in Dubai, Sharjah, and Abu Dhabi from <strong className="text-white">AED 150</strong>, with free delivery, on-site setup, and maintenance. Compliant with the UAE Personal Data Protection Law (PDPL). Rental terms are customised to your usage — from a single event to a long-term contract — and outright purchase is available too.
                </p>
              </div>
